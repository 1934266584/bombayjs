(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global = global || self), factory((global.vuePluginsApi = {})));
  ...
  function handleApi(url, success, time, code, msg, beigin) {
    ...
    // 过滤忽略的url
    var include = findIndex(getConfig('ignore').ignoreApis, function(ignoreApi) {
      return url.indexOf(ignoreApi) > -1;
    });
    if (include > -1) return;
    report(apiMsg);
  }

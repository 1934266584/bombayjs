...
var normalTarget = function(e) {
  ...
  getElmPath = function(e) {
    ...
    for (var r = e || null; r && n++ < 5 && 'html' !== (o = normalTarget(r)); )
...
function handleClick(e) {
  ...
  if ('INPUT' !== o.nodeName && 'TEXTAREA' !== o.nodeName && 0 !== o.length) {
    var r = { type: 'ui.click', data: { path: getElmPath(o), message: '' } };
    if (!r.data.path) return;
    var a = getCommonMsg();
    report(__assign(__assign({}, a), { t: 'behavior', behavior: r }));
  }
}
  ...
  if (e && 'object' == typeof e)
    var t = {
      ...
      a = setInterval(function() {
        if (n.loadEventEnd) {
          if ((clearInterval(a), 'function' == typeof window.PerformanceNavigationTiming)) {
          ...
          each(
            ...
            function(e, o) {
              var a = n[TIMING_KEYS[e[1]]],
                i = n[TIMING_KEYS[e[0]]],
                s = Math.round(i - a);
              if (2 === r || (void 0 !== a && void 0 !== i)) {
                if ('dom' === o) s = Math.round(i - a);
                s >= 0 && s < 36e5 && (t[o] = s);
              }
            }
          );
          ...
          if (
            ...
            1 === r && n[TIMING_KEYS[16]] > 0 && n[TIMING_KEYS[1]] > 0)
          ) {
            var d = n[TIMING_KEYS[16]] - n[TIMING_KEYS[1]];
            d >= 0 && d < 36e5 && (t.fpt = d);
          }
          1 === r && n[TIMING_KEYS[1]] > 0
            ? (t.begin = n[TIMING_KEYS[1]])
            : 2 === r && t.load > 0
            ? (t.begin = o - t.load)
            : (t.begin = o);
          var u = getCommonMsg();
          report(__assign(__assign(__assign({}, u), { t: 'perf' }), t));
        }
      }, 50);
}
...
function handleResource() {
  ...
  if ('function' == typeof window.PerformanceNavigationTiming) {
    var a = e.getEntriesByType('navigation')[0];
    a && (o = a);
  }
  if (
    (each({ dom: [10, 8], load: [14, 1] }, function(e, t) {
      var r = o[TIMING_KEYS[e[1]]],
        a = o[TIMING_KEYS[e[0]]];
      if (void 0 !== r && void 0 !== a) {
        var i = Math.round(a - r);
        i >= 0 && i < 36e5 && (n[t] = i);
      }
    }),
...
function handleApi(e, t, n, o, r, a) {
  if (e) {
    ...
    ((history[e] = function(n, o, r) {
      ...
      try {
        var c = i.split('#'),
          ...
          g = l[1] && l[1].replace(/^\/?(.*)/, '$1');
        d !== u
          ? dispatchCustomEvent('historystatechanged', u)
          : p !== g && dispatchCustomEvent('historystatechanged', g);
      } catch (t) {
          ...
          ? e.apply(window, o).then(function(e) {
              ...
              return (
                t.text().then(function(e) {
                  t.ok
                    ? handleApi(i, !0, a, status, e.substr(0, 1e3) || '', r)
                    : handleApi(i, !1, a, status, e.substr(0, 1e3) || '', r);
                }),
                e
              );
            })
  ...
  if ('function' == typeof window.XMLHttpRequest) {
    ...
    (window.__oXMLHttpRequest_ = n),
      (window.XMLHttpRequest = function(o) {
        var r = new n(o);
        if (!r.addEventListener) return r;
        var a = r.open,
          i = r.send;
        return (
          (r.open = function(e, n) {
            var o = 1 === arguments.length ? [arguments[0]] : Array.apply(null, arguments);
            (t = parseUrl((n = n))), a.apply(r, o);
          }),
          (r.send = function() {
            e = Date.now();
          ...
          (r.onreadystatechange = function() {
            if (t && 4 === r.readyState) {
              ...
              if (r.status >= 200 && r.status <= 299) {
                var o = r.status || 200;
                if ('function' == typeof r.getResponseHeader) {
                  var a = r.getResponseHeader('Content-Type');
                  if (a && !/(text)|(json)/.test(a)) return;
                }
                handleApi(t, !0, n, o, r.responseText.substr(0, Config.maxLength) || '', e);
              } else
                handleApi(
                  t,
                  !1,
                  n,
                  o || 'FAILED',
                  r.responseText.substr(0, Config.maxLength) || '',
                  e
                );
            }
          }),
